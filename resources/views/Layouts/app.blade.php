        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            @auth
                <nav class="flex gap-2 items-center">
                    ...
                    <a class="font-bold uppercase text-gray-600 text-sm " href="{{route('posts.index', Auth::user()->username)}}">Welcome Back:
                        <span class="lowercase text-gray-800 text-base">{{ auth()->user()->username }}</span></a>
